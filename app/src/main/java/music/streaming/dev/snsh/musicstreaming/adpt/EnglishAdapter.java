...
public class EnglishAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    List<DiscoverEnglish.Data> englishDataList;
    public EnglishAdapter.OnLoadMoreListener loadMoreListener;
    boolean isLoading = false, isMoreDataAvailable = true;

    public EnglishAdapter(Context context, List<DiscoverEnglish.Data> englishDataList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == TYPE_DATA) {
            ((MovieHolder) holder).bindData(englishDataList.get(position));
        }
    ...
    public int getItemViewType(int position) {
        if (englishDataList.get(position).type == null) {
            return TYPE_DATA;
        } else {
            if (englishDataList.get(position).type.equals("load")) {
                return TYPE_LOAD;
            } else {
                return TYPE_DATA;
            }
    ...
    static class MovieHolder extends RecyclerView.ViewHolder {
        ...
        void bindData(DiscoverEnglish.Data data) {
